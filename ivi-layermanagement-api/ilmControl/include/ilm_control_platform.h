...
struct surface_context* impl_fetch_valid_surface(struct wl_list *list_surface,
...
#define fetch_valid_surface(list_surface, surfaceID) \
    impl_fetch_valid_surface(list_surface, surfaceID)
